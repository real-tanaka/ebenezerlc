          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Ebenezer</span>{" "}
                <span className="block text-indigo-600 xl:inline">
                  Legal Consultancy
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                Ebenezer Legal Consultants is a dynamic health care consulting
                service, focusing on law, regulation and policy in the health
                sector. They are committed to overcoming challenges in health
                care regarding policy and law.
              </p>
